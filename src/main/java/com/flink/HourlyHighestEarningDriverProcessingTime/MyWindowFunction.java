...
public class MyWindowFunction
		implements WindowFunction<Tuple3<String, Integer, Long>, Tuple2<String, Integer>, Tuple2<String, String>, TimeWindow> {

	int windowCounter = 0;

	private static final long serialVersionUID = 7914655115431649968L;

	public void apply(Tuple2<String, String> key, TimeWindow window, Iterable<Tuple3<String, Integer, Long>> input,
